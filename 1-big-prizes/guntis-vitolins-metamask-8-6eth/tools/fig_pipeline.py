...
Purpose:
    Draw the MD5-to-address derivation pipeline as a left-to-right chain of
    boxes. This is the transform tools/oracle.py implements and certifies
    against the author's own published calibration vector.
