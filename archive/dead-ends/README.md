...
| [VeteranHODL: Hunting Time](veteranhodl-hunting-time-420ksats/) | 420,000 sats | solved-by-others | 2026-08-21 | the mechanism is understood and a candidate word pool exists for all 12 positions; the combinatorial sweep of that pool is only about 20 percent run and was not compared against the target address, and the wallet format the author named (Electrum) has no certified oracle yet |
| [FTPK Season 4: Something in Common](ftpk-season-4-166usdc/) | 166 USDC | solved-by-others | 2026-08-21 | the derivation is certified and the site is fully mirrored; the author's own hint says most games share a common mechanic, likely a number used as a 1-2048 BIP39 index; 1 word is established with confidence (game 1) and a 2nd is a strong candidate (game 10) |
...
| [LuckyLurker Seed Riddles](luckylurker-seed-riddles-80ksats/) | 80,000 sats | solved-by-others | 2026-08-21 | 4 of 12 words are fixed with high confidence; the other 8 are one-line riddles and about 2 million plausible synonym combinations tested against them found no match, so the intended words most likely require the site's own confirmation |
